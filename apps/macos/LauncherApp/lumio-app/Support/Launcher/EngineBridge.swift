...
@_silgen_name("lumio_search_json")
nonisolated
private func lumio_search_json(_ query: UnsafePointer<CChar>?, _ limit: UInt32) -> UnsafeMutablePointer<CChar>?

@_silgen_name("lumio_search_json_compact")
nonisolated
private func lumio_search_json_compact(_ query: UnsafePointer<CChar>?, _ limit: UInt32) -> UnsafeMutablePointer<CChar>?


@_silgen_name("lumio_record_usage_json")
nonisolated
private func lumio_record_usage_json(_ candidateID: UnsafePointer<CChar>?, _ action: UnsafePointer<CChar>?) -> UnsafeMutablePointer<CChar>?

@_silgen_name("lumio_free_cstring")
nonisolated
private func lumio_free_cstring(_ ptr: UnsafeMutablePointer<CChar>?)

@_silgen_name("lumio_reload_config")
nonisolated
private func lumio_reload_config() -> Bool

@_silgen_name("lumio_request_index_refresh")
nonisolated
private func lumio_request_index_refresh() -> Bool

@_silgen_name("lumio_translate_json")
nonisolated
private func lumio_translate_json(_ text: UnsafePointer<CChar>?, _ targetLang: UnsafePointer<CChar>?) -> UnsafeMutablePointer<CChar>?

@_silgen_name("lumio_fuzzy_score")
nonisolated
private func lumio_fuzzy_score(_ query: UnsafePointer<CChar>?, _ title: UnsafePointer<CChar>?) -> Int64
...
@_silgen_name("lumio_classify_url_json")
nonisolated
private func lumio_classify_url_json(_ query: UnsafePointer<CChar>?) -> UnsafeMutablePointer<CChar>?

@_silgen_name("lumio_record_url_hit")
nonisolated
private func lumio_record_url_hit(_ url: UnsafePointer<CChar>?) -> Bool

@_silgen_name("lumio_recent_urls_json")
nonisolated
private func lumio_recent_urls_json(_ query: UnsafePointer<CChar>?, _ limit: UInt32) -> UnsafeMutablePointer<CChar>?

@_silgen_name("lumio_clipboard_record")
nonisolated
private func lumio_clipboard_record(_ content: UnsafePointer<CChar>?, _ appBundleID: UnsafePointer<CChar>?) -> Int64

@_silgen_name("lumio_clipboard_record_image")
nonisolated
private func lumio_clipboard_record_image(_ label: UnsafePointer<CChar>?, _ imageHash: UnsafePointer<CChar>?, _ appBundleID: UnsafePointer<CChar>?) -> Int64

@_silgen_name("lumio_clipboard_images_dir")
nonisolated
private func lumio_clipboard_images_dir() -> UnsafeMutablePointer<CChar>?

@_silgen_name("lumio_clipboard_list_json")
nonisolated
private func lumio_clipboard_list_json(_ kind: UnsafePointer<CChar>?, _ query: UnsafePointer<CChar>?, _ limit: UInt32) -> UnsafeMutablePointer<CChar>?

@_silgen_name("lumio_clipboard_delete")
nonisolated
private func lumio_clipboard_delete(_ id: Int64) -> Bool

@_silgen_name("lumio_clipboard_clear")
nonisolated
private func lumio_clipboard_clear() -> UInt32
...
@_silgen_name("lumio_lunar_date_json")
nonisolated
private func lumio_lunar_date_json(_ year: Int64, _ month: Int64, _ day: Int64, _ tz: Double) -> UnsafeMutablePointer<CChar>?
...
@_silgen_name("lumio_tool_action_json")
nonisolated
private func lumio_tool_action_json(_ action: UnsafePointer<CChar>?, _ candidateID: UnsafePointer<CChar>?, _ rowTitle: UnsafePointer<CChar>?, _ path: UnsafePointer<CChar>?, _ isDir: Bool, _ ancestorsJSON: UnsafePointer<CChar>?) -> UnsafeMutablePointer<CChar>?

@_silgen_name("lumio_perform_tool_action_json")
nonisolated
private func lumio_perform_tool_action_json(_ action: UnsafePointer<CChar>?, _ candidateID: UnsafePointer<CChar>?, _ rowTitle: UnsafePointer<CChar>?, _ path: UnsafePointer<CChar>?, _ isDir: Bool, _ ancestorsJSON: UnsafePointer<CChar>?) -> UnsafeMutablePointer<CChar>?

@_silgen_name("lumio_netspeed_run_json")
nonisolated
private func lumio_netspeed_run_json() -> UnsafeMutablePointer<CChar>?
...
final class EngineBridge: @unchecked Sendable {
    ...
    nonisolated func search(query: String, limit: Int = 40) -> [LauncherResult] {
        let ptr = query.withCString { cstr in
            lumio_search_json_compact(cstr, UInt32(limit))
        }
    ...
    nonisolated func recordUsage(candidateID: String, action: String) -> BridgeError? {
        let ptr = candidateID.withCString { idCstr in
            action.withCString { actionCstr in
                lumio_record_usage_json(idCstr, actionCstr)
            }
        }
    ...
    nonisolated func lunarDate(year: Int, month: Int, day: Int, tzHours: Double) -> LunarDate? {
        guard let ptr = lumio_lunar_date_json(Int64(year), Int64(month), Int64(day), tzHours) else {
            return nil
        }
        defer { lumio_free_cstring(ptr) }
    ...
    nonisolated func speedTest() -> SpeedTestOutcome {
        guard let ptr = lumio_netspeed_run_json() else {
    ...
    nonisolated func translate(text: String, targetLang: String = "en") -> TranslationResult? {
        let result = text.withCString { textCstr in
            targetLang.withCString { langCstr in
                lumio_translate_json(textCstr, langCstr)
            }
        }
    ...
    nonisolated func fuzzyScore(query: String, title: String) -> Int? {
        let score = query.withCString { queryCstr in
            title.withCString { titleCstr in
                lumio_fuzzy_score(queryCstr, titleCstr)
            }
        }
    ...
    nonisolated func classifyURL(query: String) -> URLMatch? {
        let ptr = query.withCString { lumio_classify_url_json($0) }
    ...
    /// suggestions. Fire-and-forget; opens the shared lumio.db (own connection).
    @discardableResult
    nonisolated func recordURLHit(url: String) -> Bool {
        url.withCString { lumio_record_url_hit($0) }
    }
    ...
    nonisolated func toolAction(
        ...
        let ptr = row.withCStrings { candidate, title, path, ancestors in
            action.withCString { action in
                lumio_tool_action_json(action, candidate, title, path, isDirectory, ancestors)
            }
        }
    ...
    nonisolated func performToolAction(
        ...
        let ptr = row.withCStrings { candidate, title, path, ancestors in
            action.withCString { action in
                lumio_perform_tool_action_json(action, candidate, title, path, isDirectory, ancestors)
            }
        }
        return Self.decodeToolAction(ptr)
    }
    ...
    /// Opens the shared lumio.db - call off the main thread.
    nonisolated func recentURLs(query: String, limit: Int) -> [URLHistoryEntry] {
        let ptr = query.withCString { lumio_recent_urls_json($0, UInt32(limit)) }
    ...
    /// One remembered clip, as stored in the shared lumio.db.
        ...
        let id = content.withCString { contentC in
            if let appBundleID {
                return appBundleID.withCString { appC in
                    lumio_clipboard_record(contentC, appC)
                }
            }
            return lumio_clipboard_record(contentC, nil)
        }
        return id > 0 ? id : nil
    }
    ...
    nonisolated func recordClipboardImage(
        ...
        let id = label.withCString { labelC in
            imageHash.withCString { hashC in
                if let appBundleID {
                    return appBundleID.withCString { appC in
                        lumio_clipboard_record_image(labelC, hashC, appC)
                    }
                }
                return lumio_clipboard_record_image(labelC, hashC, nil)
            }
        }
        return id > 0 ? id : nil
    }
    ...
    nonisolated func clipboardImagesDirectory() -> URL? {
        guard let ptr = lumio_clipboard_images_dir() else { return nil }
        defer { lumio_free_cstring(ptr) }
    ...
    /// first). An empty query returns the most recent. Opens lumio.db - call off
    /// the main thread.
    nonisolated func clipboardEntries(
        ...
        let ptr = kind.withCString { kindC in
            query.withCString { queryC in
                lumio_clipboard_list_json(kindC, queryC, UInt32(limit))
            }
        }
        guard let ptr else { return [] }
        defer { lumio_free_cstring(ptr) }
...
/// Wire shape of `lumio_answers::UrlMatch`: the resolved openable URL and how
...
nonisolated struct ToolAction: Decodable {
    enum Kind: String, Decodable {
        /// Composed shell text. Only `lumio_tool_action_json` returns this;
