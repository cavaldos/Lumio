...
use lumio_lunar::solar_to_lunar;
use std::ffi::CString;
...
/// `LunarDate` object (`{day, month, year, leap}`). Free with `lumio_free_cstring`.
pub(crate) fn lumio_lunar_date_json_impl(year: i64, month: i64, day: i64, tz: f64) -> *mut c_char {
